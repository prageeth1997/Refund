...
//        });
       ...
       // final int ipath = (int) i.getExtras().get("imagepath");
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.mad.mad_app.Item item = new com.mad.mad_app.Item(itemName,itemDesc, itemPrice);
                addToCart(item);
            }
        });
    }

    public void addToCart(com.mad.mad_app.Item item){
    ...
    public void goToCategoryPage() {
        Intent i = new Intent(this, com.mad.mad_app.dCategoryPage.class);
        startActivity(i);
    }
}
