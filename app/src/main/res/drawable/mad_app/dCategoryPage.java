...
public class dCategoryPage extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public void getItemList(String categortname) {
        Intent i = new Intent(this, com.mad.mad_app.dMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dactivity_category_page);
...
//                        .setAction("Action", null).show();
        ...
        CardView speaker = (CardView) findViewById(R.id.cardView4);
        covers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getItemList("speaker");
    ...
    public void goToShoppingCart() {
        Intent i = new Intent(this, com.mad.mad_app.dShoppingCartPage.class);
        startActivity(i);
    }
