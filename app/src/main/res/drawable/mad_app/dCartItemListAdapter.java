...
class dCartItemListAdapter extends ArrayAdapter<com.mad.mad_app.dCartItem> {
    private Context context;
    private int resource;
    private Callable deleteCallback;

    public dCartItemListAdapter(Context context, int resource, List<com.mad.mad_app.dCartItem> objects, Callable deleteCallback) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        com.mad.mad_app.Item item = getItem(position).getItem();
...
//
    ...
    public void removeCartitem(com.mad.mad_app.dCartItem item) {
        com.mad.mad_app.dShoppingCart.removeFromCart(item);
